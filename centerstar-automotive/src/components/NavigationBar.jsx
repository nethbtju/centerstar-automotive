...
function NavigationBar() {
    return (
        <div className="bg-nav-color w-full flex flex-col sm:flex-row items-center justify-between sm:ps-10 sm:pe-10 sm:p-4"> {/* Adjust padding */}
            <img src={logo} alt="logo" className="w-64 mb-1 sm:mb-0"/> {/* Adjust margin */}
